...
class TopUp extends React.Component {
  ...
  _openQRCode() {
    console.log('11111');
    this._closeModal();
    this.setState({isVisibleQRCode: true});
  }
      ...
      setTimeout(() => {
        switch (title) {
          ...
          case I18n.t('CallScreen.cancel'):
            this._closeModal();
            break;
          case I18n.t('topUp.directPayment'):
            this._openQRCode();
            break;
          default:
            break;
      ...
      return (
        <Col size={3} key={index} style={styles.itemWrap}>
          <TouchableOpacity onPress={() => this._onPressItem(item)}>
            <View
              style={isSelected ? styles.innerWrap : styles.innerWrapInActive}>
              <AppText
              ...
              {isSelected && (
                <AppText
                  ...
                  style={
                    isSelected ? styles.moneyText : styles.moneyTextInActive
                  }
                />
              )}
            </View>
      ...
      <View style={styles.container}>
        ...
        <View>
          ...
          <View style={{marginVertical: PD.PADDING_4}}>
            <TouchableOpacity
              ...
              <AppText
                text={I18n.t('topUp.findout')}
                style={styles.descMiddle}
              />
            </TouchableOpacity>
          </View>
        </View>
        ...
        {isVisibleQRCode && (
          <Modal
            ...
            onBackButtonPress={() => this.setState({isVisibleQRCode: false})}
            onBackdropPress={() => this.setState({isVisibleQRCode: false})}
            // hasBackdrop = {false}
            // backdropColor = {'white'}
            // backdropOpacity = {0}
            style={{
            ...
            <View
              ...
              <View>
                <Text style={{fontSize: 16, marginBottom: 10, fontWeight: '700'}}>
                  Bạn vui lòng thanh toán vào tk ở bên dưới:
                </Text>
                <Text style = {{fontWeight: '600'}}>Ngân Hàng: TP Bank</Text>
                <Text style = {{fontWeight: '600'}}>STK: 0865659232</Text>
                <Text style = {{fontWeight: '600'}}>Chủ TK: Pham Quang Dao</Text>
                <Text style = {{fontWeight: '600'}}>Nội dung: sđt của bạn</Text>
              </View>
            </View>
          </Modal>
        )}
